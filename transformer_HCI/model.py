...
def Model(features, labels, mode, params):
    ...
    labels_ = tf.compat.v1.one_hot(labels, params['vocabulary_length'])
    loss = tf.compat.v1.reduce_mean(tf.compat.v1.nn.softmax_cross_entropy_with_logits_v2(logits=logits, labels=labels_))
